...
(function() {
    ...
    widget.innerHTML = `
        <style>
            ...
            .accessibility-dark-mode a:visited {
            ...
            .accessibility-focus-indicators a:focus,
            .accessibility-focus-indicators button:focus,
            .accessibility-focus-indicators input:focus,
            .accessibility-focus-indicators textarea:focus,
            .accessibility-focus-indicators select:focus {
                outline: 4px solid #ffb000 !important;
                outline-offset: 2px !important;
                box-shadow: 0 0 0 2px #ffffff, 0 0 0 6px #ffb000, 0 0 8px rgba(255, 176, 0, 0.4) !important;
            ...
            .accessibility-focus-indicators *:focus-visible {
                ...
                outline-offset: 2px !important;
                box-shadow: 0 0 0 2px #ffffff, 0 0 0 6px #ff4444, 0 0 12px rgba(255, 68, 68, 0.5) !important;
            }
            ...
            .accessibility-reduce-motion [autoplay] {
                animation-play-state: paused !important;
            }
            
            .accessibility-reduce-motion video[autoplay],
            .accessibility-reduce-motion audio[autoplay] {
                animation-play-state: paused !important;
            }
    ...
    toggleBtn.addEventListener('click', () => {
        ...
        // Apply animation based on reduce motion setting
        if (!accessibilityState['reduce-motion']) {
            menu.style.animation = isVisible ? 'slideOut 0.2s ease' : 'slideIn 0.3s ease';
        } else {
            menu.style.animation = 'none';
        }
    });
    
    // Enhanced motion control function
    function updateMotionSettings() {
        const reduceMotion = accessibilityState['reduce-motion'];
        const styleSheet = document.querySelector('#accessibility-motion-override') || document.createElement('style');
        
        if (!document.querySelector('#accessibility-motion-override')) {
            styleSheet.id = 'accessibility-motion-override';
    ...
    // Enhanced focus indicator function
    function enhanceFocusIndicators() {
        const focusEnabled = accessibilityState['focus-indicators'];
        
        if (focusEnabled) {
            // Add keyboard navigation enhancement
            document.addEventListener('keydown', handleKeyboardNavigation);
            
            // Add focus trap for the widget when open
    ...
    function applyAccessibilityFeature(feature, enabled) {
        ...
        // Call specific enhancement functions
        if (feature === 'reduce-motion') {
            updateMotionSettings();
        } else if (feature === 'focus-indicators') {
